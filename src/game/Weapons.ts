...
export const WEAPONS: Record<WeaponId, WeaponDef> = {
  pistol: {
    ...
    magSize: 12, reserveMax: 96, reloadTime: 1.2,
  ...
  smg: {
    ...
    magSize: 30, reserveMax: 150, reloadTime: 1.6,
  ...
  shotgun: {
    ...
    magSize: 6, reserveMax: 36, reloadTime: 2.2,
  ...
  sniper: {
    ...
    magSize: 5, reserveMax: 25, reloadTime: 2.0,
